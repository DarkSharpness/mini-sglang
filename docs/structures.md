...
- `minisgl.layers`: Implements basic building blocks for building LLMs with tp support, including linear, layernorm, embedding, RoPE, etc. They share common base classs defined in `minisgl.layers.base`.
